...
class Radarr::Model::SystemResource < Radarr::Model
  ...
  @[JSON::Field(key: "buildTime", converter: Radarr::TimeConverter)]
  ...
  @[JSON::Field(key: "startTime", converter: Radarr::TimeConverter)]
  ...
  property package_update_mechanism : Radarr::UpdateMechanism?
