...
class Radarr::Model::HostConfigResource < Radarr::Model
  @[JSON::Field(key: "id")]
  property id : Int32?
  ...
  property authentication_method : Radarr::AuthenticationType?

  @[JSON::Field(key: "authenticationRequired")]
  property authentication_required : Radarr::AuthenticationRequiredType?
  ...
  property update_mechanism : Radarr::UpdateMechanism?
  ...
  property proxy_type : Radarr::ProxyType?
  ...
  property certificate_validation : Radarr::CertificateValidationType?
