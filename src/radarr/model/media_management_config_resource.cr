...
class Radarr::Model::MediaManagementConfigResource < Radarr::Model
  @[JSON::Field(key: "id")]
  property id : Int32?

  @[JSON::Field(key: "autoUnmonitorPreviouslyDownloadedMovies")]
  property auto_unmonitor_previously_downloaded_movies : Bool?
  ...
  property download_propers_and_repacks : Radarr::ProperDownloadTypes?

  @[JSON::Field(key: "createEmptyMovieFolders")]
  property create_empty_movie_folders : Bool?

  @[JSON::Field(key: "deleteEmptyFolders")]
  property delete_empty_folders : Bool?

  @[JSON::Field(key: "fileDate")]
  property file_date : Radarr::FileDateType?

  @[JSON::Field(key: "rescanAfterRefresh")]
  property rescan_after_refresh : Radarr::RescanAfterRefreshType?

  @[JSON::Field(key: "autoRenameFolders")]
  property auto_rename_folders : Bool?

  @[JSON::Field(key: "pathsDefaultStatic")]
  property paths_default_static : Bool?
